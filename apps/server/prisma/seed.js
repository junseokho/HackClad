...
async function main() {
    ...
    const rosetteCardIdByCode = rosetteCards.reduce((acc, c) => {
        acc[c.code] = c.id;
        return acc;
    }, {});
    ...
    const flareCardIdByCode = flareCards.reduce((acc, c) => {
        acc[c.code] = c.id;
        return acc;
    }, {});
    const lunaCardCodes = [
    ...
    const lunaCardIdByCode = lunaCards.reduce((acc, c) => {
        acc[c.code] = c.id;
        return acc;
    }, {});
    const miaCardCodes = [
    ...
    const miaCardIdByCode = miaCards.reduce((acc, c) => {
        acc[c.code] = c.id;
        return acc;
    }, {});
    ...
    const ameliaCardIdByCode = ameliaCards.reduce((acc, c) => {
        acc[c.code] = c.id;
        return acc;
    }, {});
    // Character pools
