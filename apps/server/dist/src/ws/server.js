...
import { clients, send, sendError, getRoomClients, cleanupClient, pruneEmptyRooms, } from "./state.js";
import { verifyToken } from "../http/auth.js";
import { joinMatchmaking, leaveMatchmaking } from "./matchmaking.js";
// ✅ game handlers
import { handleGameSubscribe, handlePvpReady, handlePvpChooseSlot, handlePvpPickEnhanced, handlePvpPlayCard, handlePvpBasicAction, handlePvpCpAction, handlePvpMiaTrapAttack, handlePvpReact, handlePvpCrack, handlePvpEnter, handleGameChoice, handlePvpEndTurn, handleAdvancePhaseDebug, } from "./game.js";
    ...
    wss.on("connection", (ws, _req) => {
        ...
        ws.on("message", (raw) => {
            ...
            if (msg.type === "pvp:chooseSlot") {
                handlePvpChooseSlot(client, msg.roomId, msg.slot, msg.turnCardCode, msg.spawn ?? null, msg.returnCardCode ?? null, msg.moveTarget ?? null, getRoomClients(msg.roomId));
                return;
            }
            ...
            if (msg.type === "pvp:playCard") {
                handlePvpPlayCard(client, msg.roomId, msg.cardCode, msg.dir, getRoomClients(msg.roomId));
                return;
            }
